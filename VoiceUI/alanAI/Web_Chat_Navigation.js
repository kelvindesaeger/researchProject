...
intent(
  ...
  p => {
    ...
    p.play(
      "(Here is something about me|This is a bit of information about me|Here are some details about myself that I'd like to share)",
    )
  },
)
...
intent(
  ...
  p => {
    ...
    p.play(
      'We provide a variety of burgers, sides and drinks. Feel free to ask for more information.',
    )
  },
)

intent('Go to (cart|shoppingcart|shoppingbasket)', p => {
  p.play({ command: 'openURL', url: '/cart' }, opts({ force: true }))
  p.play(
    "(Here is a list of services I provide|Here's a breakdown of the services I specialize in|These are the services that I offer)",
  )
})

// Opening a resume
intent('Do you have a resume', 'Where can I find (the|your|) resume', p => {
  p.play(
    {
      command: 'openURL',
      url: 'assets/pdf/alan-turing-jr-resume.pdf',
